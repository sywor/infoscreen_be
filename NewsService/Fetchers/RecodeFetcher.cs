...
namespace NewsService.Fetchers
{
    public class RecodeFetcher : AbstractWebPageFetcher<RecodeFetcher>
    {
        ...
        public RecodeFetcher(NewsSourceConfigurations _newsSourceConfigurations, MinioConfiguration _minioConfiguration, RedisCacheService _redis, ILoggerFactory _loggerFactory) :
