...
namespace NewsService.Fetchers
{
    public class PolygonFetcher : AbstractRssFetcher<PolygonFetcher>
    {
        ...
        public PolygonFetcher(NewsSourceConfigurations _newsSourceConfigurations, MinioConfiguration _minioConfiguration, RedisCacheService _redis, ILoggerFactory _loggerFactory) :
